...
\todo[inline]{Given that the formula above is for $R_{IC}$, I would have expected you to give me this, and to tell me where it is in units of the BH radius or something so I could put it in context.  ksl}
...
\todo[inline]{In the next paragraph you use the words "continuum driving" to describe radiation pressure due to electrons scattering.  You did not use this term earlier in the introduction anywhere that I could find.  My preference would be to refer to this as radiative driving ... but whatever you do it should be consistent with the introduction. ksl}
...
\todo[inline]{Regarding the figures, in the text you use L$_{Edd}$.  In the figures, you use L$_{edd}$.  Ideally these would be the same, though I guess you could argue that your are consistent in the two places.  I favor L$_{Edd}$  More important, the labels in the figures are very small.  My rule of thumb is that you should be able to take the figure and display it in a presentation.  None of your figures pass my test.  I think the paper would be much easier to read if you would make an attempt to increase the label sizes.  The worst figure in this regard is Fig. 6 which has microscopic labels. }
