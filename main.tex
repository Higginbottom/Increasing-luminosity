...
and it is therefore tempting ascribe the difference in the line profile around 0 $kms^{-1}$ to the change from 
...
places, and this dense gas would presumably end up more distributed in velocity space. 
