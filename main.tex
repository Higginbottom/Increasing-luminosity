...
adopt the same logarithmic grid as in H18, with 200 radial cells running from $0.2R_{IC} \leq r \leq 20 R_{IC}$
...
of including a small wedge of static material in the grid. In order to give
...
(assuming the same 8.3 per cent accretion efficiency as in H18), we find that
...
launched. D18 estimate this reduction to be 
\begin{equation}
